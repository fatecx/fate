...
export const MOODS: Record<string, SoundDef> = {
  ...
  first_rung: {
    ...
    film: true,
    source: 'music',
    prompt: 'Haunting space score. Rising organ melody, strings, G minor, 68 BPM. Harmony moves. Not a clock.',
  },
  aurelia: {
    id: 'mus_aurelia',
    gain: 0.4,
    ...
    film: true,
    source: 'music',
    prompt: 'Haunting space score. Long organ melody, strings, a country founding, D minor, 64 BPM. Grand, unresolved.',
  },
  the_road: {
    id: 'mus_the_road',
    gain: 0.4,
    ...
    film: true,
    source: 'music',
    prompt: 'Haunting space score. Climbing string melody over organ, A minor, 72 BPM. A person riding into the sky.',
  },
  hustle: {
    id: 'mus_hustle',
    gain: 0.3,
