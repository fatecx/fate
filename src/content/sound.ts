...
export const MOODS: Record<string, SoundDef> = {
  ...
  first_rung: {
    ...
    film: true,
    source: 'music',
    prompt: 'Interstellar family. Organ as a construction engine, ticking, C-sharp minor, 12/8, 100 BPM.',
  },
  aurelia: {
    id: 'mus_aurelia',
    gain: 0.4,
    ...
    film: true,
    source: 'music',
    prompt: 'Interstellar family. Organ ostinato as a country founding. D minor, 12/8, 88 BPM, unresolved.',
  },
  the_road: {
    id: 'mus_the_road',
    gain: 0.4,
    ...
    film: true,
    source: 'music',
    prompt: 'Interstellar family. Organ as a spacecraft engine, 5/4 docking ostinato, F minor, 96 BPM.',
  },
  hustle: {
    id: 'mus_hustle',
    gain: 0.3,
