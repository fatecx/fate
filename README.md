...
**A narrative founder saga. One life. Nine companies. Every scar carries forward.**
...
- **The Ladder**: 3 tiers × 3 companies = 9 playable startups across one biography. Founder Score gates tier access; failures still accrue score — there are no dead ends.
- **Three meters total**: Runway, Stress, Reputation. Everything else is fiction.
...
- **Chapter One** opens with *The Last Mile* — an independent autonomous delivery network fighting the giants in the neighborhoods they ignore.
