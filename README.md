...
**A narrative founder saga. One life. Three companies. Every scar carries forward.**
...
- **Three chapters, fixed order**: HYPERCHUTE (garage delivery railway) → TELEPORT (Moon telepresence) → SKYLINE (space elevator). No selection screen — each life opens when the last one ends.
